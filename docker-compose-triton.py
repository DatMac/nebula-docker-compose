...
services:
  ...
  metad0:
    ...
    ports:
      ...
      - 19560
    volumes:
      - /nebula_hdfs/data/meta0:/data/meta
      - /nebula_hdfs/logs/meta0:/logs
    networks:
      - nebula-net
    restart: on-failure
    cap_add:
  ...
  metad1:
    ...
    ports:
      ...
      - 19560
    volumes:
      - /nebula_hdfs/data/meta1:/data/meta
      - /nebula_hdfs/logs/meta1:/logs
    networks:
      - nebula-net
    restart: on-failure
    cap_add:
  ...
  metad2:
    ...
    ports:
      ...
      - 19560
    volumes:
      - /nebula_hdfs/data/meta2:/data/meta
      - /nebula_hdfs/logs/meta2:/logs
    networks:
      - nebula-net
    restart: on-failure
    cap_add:
  ...
  storaged0:
    ...
    ports:
      ...
      - 19780
    volumes:
      - /nebula_hdfs/data/storage0:/data/storage
      - /nebula_hdfs/logs/storage0:/logs
    networks:
      - nebula-net
    restart: on-failure
    cap_add:
  ...
  storaged1:
    ...
    ports:
      ...
      - 19780
    volumes:
      - /nebula_hdfs/data/storage1:/data/storage
      - /nebula_hdfs/logs/storage1:/logs
    networks:
      - nebula-net
    restart: on-failure
    cap_add:
  ...
  storaged2:
    ...
    ports:
      ...
      - 19780
    volumes:
      - /nebula_hdfs/data/storage2:/data/storage
      - /nebula_hdfs/logs/storage2:/logs
    networks:
      - nebula-net
    restart: on-failure
    cap_add:
